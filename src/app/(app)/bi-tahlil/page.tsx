...
export default async function BiTahlil({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return (
    <BiPage title="Rahbar markazi" subtitle="Moliyaviy nazorat tizimi — bugun qancha pul yo'qotilyapti, qayerda xavf bor va nima qilish kerak. Barcha raqamlar joriy holatdan hisoblanadi." eyebrow="BI tahlil · Moliyaviy nazorat" tab="overview" range={range}>
