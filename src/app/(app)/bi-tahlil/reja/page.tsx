...
import { Target, Wallet, Percent, Gauge, AlertTriangle, Award, Users, Trash2 } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
          <Panel className="xl:col-span-2" title="Forecast engine" eyebrow="oylik ko'rsatkich" info="Kumulyativ fakt (uzluksiz) + prognoz (uzuq, hozirgi ish kuni tempi bilan) + reja chizig'i (ish kunlariga teng taqsimlangan).">
            <LineChart labels={d.engine.labels} series={[{ name: "Fakt (kumulyativ)", values: d.engine.cumVals, color: "#f59e0b" }, { name: "Prognoz", values: d.engine.fcVals, color: "#3b82f6", dashed: true }, { name: "Reja", values: d.engine.planVals, color: "#94a3b8", dashed: true }]} formatValue={(v) => `${moneyShort(v)} so'm`} labelEvery={3} height={220} />
